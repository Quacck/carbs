...
python3 src/run.py --scheduling-policy suspend-resume --task-trace different_lengths --dynamic-power-draw --dynamic-power-draw-type periodic-phases --dynamic-power-draw-phases "{'startup':[{'name': 'startup','duration': 0, 'power': 150}],'work':[{'name': 'high', 'power': 200, 'duration': 3600}, {'name': 'low', 'power': 100, 'duration': 3600}]}" --carbon-policy oracle --start-index 7000 --w 48 --filename results/simulation/different_lengths/suspend-resume_periodic-phases_0_0_100_48 --repeat
