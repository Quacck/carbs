...
python3 src/run.py --scheduling-policy carbon --task-trace single-job --dynamic-power-draw --dynamic-power-draw-type constant-from-periodic-phases --dynamic-power-draw-phases "{'startup':[{'name': 'startup','duration': 240, 'power': 150}],'work':[{'name': 'high', 'power': 200, 'duration': 1800}, {'name': 'low', 'power': 100, 'duration': 1800}]}" --carbon-policy oracle --start-index 8000 --w 24 --filename results/simulation/evaluation/carbon_constant-from-periodic-phases_0_240_100_24 --repeat
