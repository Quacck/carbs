...
python3 src/run.py --scheduling-policy carbon --carbon-trace DE-hourly-09-02-to-09-15 --task-trace evaluation_jobs --dynamic-power-draw --dynamic-power-draw-type constant-from-periodic-phases --dynamic-power-draw-phases "{'startup':[{'name': 'startup','duration': 300, 'power': 200}],'work':[{'name': 'high', 'power': 200, 'duration': 3600}, {'name': 'low', 'power': 100, 'duration': 1800}]}" --carbon-policy oracle --start-index 0 --w 48 --filename results/simulation/evaluation_jobs/carbon_constant-from-periodic-phases_1_300_200_48 --repeat
