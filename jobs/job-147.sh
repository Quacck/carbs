...
python3 src/run.py --scheduling-policy carbon --task-trace different_lengths --dynamic-power-draw --dynamic-power-draw-type constant-from-periodic-phases --dynamic-power-draw-phases "{'startup':[{'name': 'startup','duration': 600, 'power': 150}],'work':[{'name': 'high', 'power': 200, 'duration': 3600}, {'name': 'low', 'power': 100, 'duration': 1800}]}" --carbon-policy oracle --start-index 7000 --w 24 --filename results/simulation/different_lengths/carbon_constant-from-periodic-phases_1_600_100_24 --repeat
