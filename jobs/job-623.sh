...
python3 src/run.py --scheduling-policy suspend-resume --task-trace single-job --dynamic-power-draw --dynamic-power-draw-type constant-from-periodic-phases --dynamic-power-draw-phases "{'startup':[{'name': 'startup','duration': 120, 'power': 150}],'work':[{'name': 'high', 'power': 200, 'duration': 900}, {'name': 'low', 'power': 100, 'duration': 2700}]}" --carbon-policy oracle --start-index 8000 --w 12 --filename results/simulation/evaluation/suspend-resume_constant-from-periodic-phases_2_120_100_12 --repeat
