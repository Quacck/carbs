...
python3 src/run.py --scheduling-policy carbon --task-trace single-job --dynamic-power-draw --dynamic-power-draw-type periodic-phases --dynamic-power-draw-phases "{'startup':[{'name': 'startup','duration': 0, 'power': 150}],'work':[{'name': 'high', 'power': 200, 'duration': 900}, {'name': 'low', 'power': 100, 'duration': 2700}]}" --carbon-policy oracle --start-index 8000 --w 4 --filename results/simulation/evaluation/carbon_periodic-phases_2_0_100_4 --repeat
