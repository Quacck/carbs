...
python3 src/run.py --scheduling-policy carbon --carbon-trace DE-hourly-09-02-to-09-15 --task-trace evaluation_jobs --dynamic-power-draw --dynamic-power-draw-type periodic-phases --dynamic-power-draw-phases "{'startup':[{'name': 'startup','duration': 600, 'power': 100}],'work':[{'name': 'high', 'power': 200, 'duration': 3600}, {'name': 'low', 'power': 100, 'duration': 3600}]}" --carbon-policy oracle --start-index 0 --w 12 --filename results/simulation/evaluation_jobs/carbon_periodic-phases_0_600_100_12 --repeat
