...
python3 src/run.py --scheduling-policy carbon --task-trace single-job --dynamic-power-draw --dynamic-power-draw-type periodic-phases --dynamic-power-draw-phases "{'startup':[{'name': 'startup','duration': 180, 'power': 150}],'work':[{'name': 'high', 'power': 200, 'duration': 1800}, {'name': 'low', 'power': 100, 'duration': 1800}]}" --carbon-policy oracle --start-index 8000 --w 24 --filename results/simulation/evaluation/carbon_periodic-phases_0_180_300_24 --repeat
