...
python3 src/run.py --scheduling-policy suspend-resume --task-trace different_lengths --dynamic-power-draw --dynamic-power-draw-type periodic-phases --dynamic-power-draw-phases "{'startup':[{'name': 'startup','duration': 240, 'power': 150}],'work':[{'name': 'high', 'power': 200, 'duration': 2700}, {'name': 'low', 'power': 100, 'duration': 900}]}" --carbon-policy oracle --start-index 8000 --w 24 --filename results/simulation/different_lengths/suspend-resume_periodic-phases_1_240_100_24 --repeat
