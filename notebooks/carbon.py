...
# Just copy this because python modules are whack
class CarbonModel():
...
def get_carbon_model(carbon_trace:str, carbon_start_index:int, carbon_error: str="ORACLE") -> CarbonModel:
    ...
    # 17544 == 2*365*24 also praktisch 2 Jahre nach dem Anfang. Also 2022
    # 720 == 24*30 also ein Monat an carbon traces
